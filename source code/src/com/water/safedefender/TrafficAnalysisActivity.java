...
import com.water.safedefender.utils.TrafficStatUtils;

public class TrafficAnalysisActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_app_manager.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				//TextView contentView = new TextView(TrafficAnalysisActivity.this);
				View contentView = View.inflate(TrafficAnalysisActivity.this, R.layout.popup_appinfo, null);
				ll_uninstall = (LinearLayout) contentView.findViewById(R.id.ll_uninstall);
				ll_start = (LinearLayout) contentView.findViewById(R.id.ll_start);
				ll_share = (LinearLayout) contentView.findViewById(R.id.ll_share);
				
				ll_uninstall.setOnClickListener(TrafficAnalysisActivity.this);
				ll_start.setOnClickListener(TrafficAnalysisActivity.this);
				ll_share.setOnClickListener(TrafficAnalysisActivity.this);
				...
				int dip = 58;
				int px = DensityUtil.dip2px(TrafficAnalysisActivity.this, dip);
	...
	private void fillData() {
		...
		new Thread(new Runnable(){
			...
			public void run() {
				...
				appInfos = AppInfoProvider.getAppInfos(TrafficAnalysisActivity.this); 
	...
	private class AppManagerAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			AppInfo appInfo ;
			if(position==0){
				TextView tv = new TextView(TrafficAnalysisActivity.this);
			...
			if(convertView!=null && convertView instanceof RelativeLayout){
				...
				view = View.inflate(TrafficAnalysisActivity.this, R.layout.list_item_appinfo, null);
			...
			//显示上传下载的流量
			holder.tv_loacation.setText(
					"下载的流量:"+
					Formatter.formatFileSize(TrafficAnalysisActivity.this,TrafficStatUtils.getDownloadTraffic(TrafficAnalysisActivity.this, 
					appInfo.getPackagename()))+
					";上传的流量:"+
					Formatter.formatFileSize(TrafficAnalysisActivity.this,TrafficStatUtils.getUploadTraffic(TrafficAnalysisActivity.this, 
					appInfo.getPackagename()))
					);
